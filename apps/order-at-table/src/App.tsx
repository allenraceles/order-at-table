...
export default function App() {
  ...
  function startAdditionalOrder() {
    if (!paymentComplete || !tableService?.current_service_id) return
    sessionStorage.removeItem(orderStorageKey)
    setOrder(null)
    setCart([])
    setPanel(null)
